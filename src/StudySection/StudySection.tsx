...
const StudySection = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-6 py-8 md:py-16 max-w-6xl mx-auto md:gap-16">
      <div className="order-2 md:order-1 md:w-1/2 space-y-6 mt-6 md:mt-0 text-center md:text-left">
        ...
        <button className="w-full md:w-auto px-4 py-2 rounded-lg bg-[#5580D4] text-white hover:bg-[#446BB3] transition">
          WATCH DEMO
        </button>
      </div>
